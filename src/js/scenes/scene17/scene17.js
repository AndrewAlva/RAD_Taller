...
import sceneVertex from './vertexScene17.glsl'
import sceneFragment from './fragmentScene17.glsl'
...
class Sketch extends SketchScene {
    ...
    setup() {
         ...
         * Object
         */
        let planeSize = new THREE.Vector2(2.23, 1.07);
        ...
        _this.material = new THREE.ShaderMaterial({
            ...
            uniforms: {
                ...
                uProgress: { value: 0. }, // MIDI hooked
                uSignal: { value: 0. }, // Microphone hooked
...
var Scene17 = new Sketch({sceneName: '17. Topografia'});
export {Scene17};
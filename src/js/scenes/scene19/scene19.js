...
class Sketch extends SketchScene {
    ...
    flowerSetup() {
        ...
        _this.flowerLayersData = [
            ...
            { id: 'p1', shaderName:'petalo', imgSrc: 'img/daits-flower/p1.png', zPos: 0.010, renderOrder: 6, uRotation: Math.PI * .075, width: 0.7390, scale: 0.7346},
            { id: 'p2', shaderName:'petalo', imgSrc: 'img/daits-flower/p2.png', zPos: 0.012, renderOrder: 7, uRotation: Math.PI * .27, width: 0.9431, scale: 0.6922},
            { id: 'p3', shaderName:'petalo', imgSrc: 'img/daits-flower/p3.png', zPos: 0.016, renderOrder: 9, uRotation: Math.PI * .475, width: 1.5714, scale: 0.4026},
            { id: 'p4', shaderName:'petalo', imgSrc: 'img/daits-flower/p4.png', zPos: 0.014, renderOrder: 8, uRotation: Math.PI * .93, width: 4.3928, scale: 0.1977},
            { id: 'p5', shaderName:'petalo', imgSrc: 'img/daits-flower/p5.png', zPos: 0.018, renderOrder: 10, uRotation: Math.PI * -.05, width: 0.6025, scale: 0.7769},

            { id: 'b1', shaderName:'bulbo', imgSrc: 'img/daits-flower/b1.png', zPos: 0.030, renderOrder: 16, uRotation: Math.PI * .15, width: 0.9841, scale: 0.4470},
            { id: 'b2', shaderName:'bulbo', imgSrc: 'img/daits-flower/b2.png', zPos: 0.028, renderOrder: 15, uRotation: Math.PI * -.12, width: 1.0276, scale: 0.3289},
            { id: 'b3', shaderName:'bulbo', imgSrc: 'img/daits-flower/b3.png', zPos: 0.024, renderOrder: 13, uRotation: Math.PI * .25, width: 0.9047, scale: 0.4238},
            { id: 'b4', shaderName:'bulbo', imgSrc: 'img/daits-flower/b4.png', zPos: 0.022, renderOrder: 12, uRotation: Math.PI * .035, width: 0.6004, scale: 0.4873},
            { id: 'b5', shaderName:'bulbo', imgSrc: 'img/daits-flower/b5.png', zPos: 0.020, renderOrder: 11, uRotation: Math.PI * -.125, width: 0.6590, scale: 0.4883},
    ...
    flowerLayer({id, shaderName, imgSrc, zPos, renderOrder, uRotation, width, scale = 1}) {
        var _this = this;
        var keys = {
